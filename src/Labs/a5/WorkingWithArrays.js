...
function WorkingWithArrays() {
  ...
  return (
    <div>
      ...
      <br />
      <label className="mt-3">TODO ID : </label>
      <input
        value={todo.id}
        onChange={(e) =>
          setTodo({
      ...
      <input
        ...
        name="completed"
      />
      <label htmlFor="completed" className="form-check-label ms-3 mt-3">
        Todo Completed ?
      </label>
      <br />
      <a
        href={`${API}/${todo.id}/completed/${todo.completed}`}
        className="btn btn-primary me-2 mt-3 mb-3"
      >
        Complete Todo for ID = {todo.id}
      </a>
      <input
      ...
      <a
        ...
        className="btn btn-primary me-2"
      >
        Describe Todo for ID = {todo.id}
      </a>
      <br />
      <br />
      <h3>ARRAYS WITH AJAX</h3>
      <br />
      <br />
      <input
        value={todo.id}
      ...
      <br />
      <h3>Using get post </h3>
      ID : <input value={todo.id} readOnly />
      <br />
      Title :{" "}
      <input
        onChange={(e) =>
